    ...
    <>
      <Card className="shadow-soft">
        <CardHeader>
          ...
          <CardDescription>Enable or disable Firebase push registration.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm font-medium">Enable push notifications</div>
              <div className="text-xs text-muted-foreground">Requires google-services.json and internet connectivity.</div>
            </div>
            <button
              type="button"
